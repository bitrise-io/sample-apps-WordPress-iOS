...
final class PostCategoryCreateViewController: UIViewController {
    private let blog: Blog
    private let onCategoryCreated: (PostCategory) -> Void

    init(blog: Blog, onCategoryCreated: @escaping (PostCategory) -> Void) {
        self.blog = blog
    ...
    override func viewDidLoad() {
        ...
        let viewController = UIHostingController(rootView: NavigationView {
            PostCategoryCreateView(blog: blog, onCategoryCreated: onCategoryCreated)
        })
